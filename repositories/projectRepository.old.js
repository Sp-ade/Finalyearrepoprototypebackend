...
class ProjectRepository {
    ...
    async createProject(projectData) {
        ...
        const query = `
            ...
            (name, title, description, department, category, academic_year, grade, status, 
             supervisor, supervisor_remark, student_names)
        ...
        const values = [
            ...
            grade,
            status,
            supervisorId, // This now contains the name string passed from service
            supervisorRemark,
    ...
    async getAllProjects() {
        const query = `
            SELECT 
                p.*,
                p.supervisor as supervisor_name,
                COALESCE(
                    json_agg(
